...
const CategorieItem: React.FC<Props> = ({ name, selectedCategorieIndex, handleClick, index }) => {
    return (
        <li className='flex items-center justify-center'>
            <span
                ...
                className={cn(
                    ...
                    selectedCategorieIndex === (typeof initialCategories[index]?.categorie !== "undefined" ? index : null) 
