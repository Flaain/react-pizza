...
const SortPopupItem: React.FC<Props> = ({ name, sort, index, selectedSortIndex, handleSort }) => {
    return (
        <li
            ...
            className={cn(
                ...
                selectedSortIndex === index && "bg-primary-orange text-white"
            )}
        >
            <svg className={cn(!sort.includes('-') && 'rotate-180')} width='11' height='9' viewBox='0 0 11 9' fill='none' xmlns='http://www.w3.org/2000/svg'>
                <g clipPath='url(#clip0_108298_2)'>
                    <path
                        ...
                        fill='#181818'
                        className={cn('group-hover:fill-white transition-colors duration-200 ease-in-out', selectedSortIndex === index && 'fill-white')}
                    />
                    <path
                        fillRule='evenodd'
                        clipRule='evenodd'
