...
const AddToCartButton = ({ title, quantity, loading, ...rest }: Props) => {
    return (
        <button
            ...
            type='button'
            className={cn(
                "active:scale-[0.98] min-w-[120px] min-h-[40px] transition-opacity duration-200 ease-in-out relative group font-bold text-base text-white bg-primary-orange py-2 px-5 rounded-full flex items-center justify-center gap-5",
