...
const SortPopup: React.FC<SortPopupProps> = ({ activeSort, setSearchParams }) => {
    ...
    return (
        <div className='flex items-center gap-2 relative'>
            ...
            >
                <svg
                    className={cn("pointer-events-none", !initialSortNames.get(activeSort)?.sort.includes("-") && "rotate-180")}
                    width='11'
                    height='9'
                    viewBox='0 0 11 9'
                    fill='none'
                ...
                {initialSortNames.get(activeSort)?.name}
            </span>
            <AnimatePresence>
