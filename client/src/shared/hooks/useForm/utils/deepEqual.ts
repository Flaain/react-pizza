...
export const deepEqual = <T extends Field>(obj1: T, obj2: T) => {
    ...
    for (const key in obj1) {
        ...
        */
        ...
        if (typeof obj1[key] === "object" && typeof obj2[key] === "object" && deepEqual(obj1[key] as Field, obj2[key] as Field)) return true;
